...
class EducationForm extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final educationList = context.watch<ResumeService>().currentResume?.education ?? [];
    final isDark = Theme.of(context).brightness == Brightness.dark;
          ...
          Align(
            ...
            child: OutlinedButton.icon(
              ...
              onPressed: () {
                ...
                context.read<ResumeService>().updateEducation(<Education>[...educationList, newEdu]);
              },
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        IconButton(
                          ...
                          onPressed: () {
                            final current = context.read<ResumeService>().currentResume?.education ?? [];
                            final newList = List<Education>.from(current)..removeAt(index);
                            context.read<ResumeService>().updateEducation(newList);
                          },
                        ),
                      ],
